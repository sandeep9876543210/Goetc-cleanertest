...
import 'package:goetc/screen/OtherScreen.dart';
...
class ChooseLocationsCar extends StatefulWidget {

  var lats,longs;

  ChooseLocationsCar({this.lats,this.longs});

  @override
  _ChooseLocationsCar createState() => _ChooseLocationsCar();
}

class _ChooseLocationsCar extends State<ChooseLocationsCar> {
  ...
  bool _validatestatename = false;

  final servicebookingid = TextEditingController();
  bool _validateservicebookid = false;

  final NameSoc = TextEditingController();
  bool _validatenamesoc = false;
  ...
  Future<void> verifyregisteration() async {
    ...
    if (msg == "success") {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ChoosePlans(servicebookingid:servicebookingid.text.toString())));
    } else {
      Fluttertoast.showToast(
          msg: "Error",
          toastLength: Toast.LENGTH_SHORT,
