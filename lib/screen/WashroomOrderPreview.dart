...
class WashroomOrderPreviewScreen extends StatefulWidget {
...
class _OrderPreviewScreenState extends State<WashroomOrderPreviewScreen> {
  bool isChecked = true;
  ...
  final NoOfSessions = TextEditingController();
  final NoOfTimes = TextEditingController();
  final SlotDate = TextEditingController();
  ...
  Future<void> loaddata() async {
    ...
    String url =
        "https://goetc-dev.com/API/servicesAPI/OrderWashroomPreview?ServiceId=4&CustomerId=" +
            CustomerId.toString() +
            '&ServiceBookId=' +
    ...
    setState(() {
      ...
      NoOfSessions.text = jsonDecode(response1.body)['NoOfWashrooms'].toString();
      NoOfTimes.text = jsonDecode(response1.body)['NoOfTimes'].toString();
      SlotDate.text = jsonDecode(response1.body)['SlotDate'].toString();
                            ...
                            if(FinalDiskamount==0.0){
                              String url =
                                  "https://goetc-dev.com/API/MasterAPI/CouponAvailability?PromoCode=" +
                                      ...
                                      '&Amount=' +
                                      price.toString()+'&ServiceId=4&CustomerId='+CustomerId.toString();
                              print(url);
                              var response1 =
                              await get(Uri.parse(url), headers: {"Accept": "application/json"});
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    String url="https://goetc-dev.com/API/ServicesAPI/BookingInvoicesDetails?BookingId="+widget.BookingId.toString();
    var response11 = await get(Uri.parse(url),
        headers: {"Accept": "application/json"});
    var urls = jsonDecode(response11.body)['Invoice'];
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => PaymentConfirmation(
                paymentid: "${response.paymentId}", totals: total.toString(),bookingid:urls,types:'Washroom Cleaning',newbookingids:''+widget.BookingId.toString())));
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    height: FinalDiskamount==0.0?150:180,
