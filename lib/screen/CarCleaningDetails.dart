...
import 'ChooseLocationsCar.dart';
import 'animated_custom_dialog.dart';
import 'guest_dialog.dart';

class CarCleaningDetails extends StatefulWidget {
  @override
  _CarCleaningDetails createState() => _CarCleaningDetails();
}

class _CarCleaningDetails extends State<CarCleaningDetails> {
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    if(Email=='guest@guest.com') {
                      SharedPreferences prefs = await SharedPreferences.getInstance();
                      prefs.setString('from', 'carwash');
                      showAnimatedDialog(context, GuestDialog(), isFlip: true);
                    }else {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => ChooseLocationsCar(lats:lat,longs:lng)));
                    }
